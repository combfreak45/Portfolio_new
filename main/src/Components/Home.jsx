      ...
      <motion.div className="h-fit flex flex-row items-center flex-wrap rounded-3xl">
        ...
        >
          <img
            src={profile}
            alt="svd"
            className=" w-[16rem]  xl:w-[25rem]  hover:scale-110 ease-in-out duration-150 rounded-3xl"
          />
        </motion.div>

        <motion.div
          className="w-full xl:w-3/5 h-1/2 sm:h-full flex flex-col xl:gap-5 justify-center items-center"
          initial={{
            scale: 0,
          }}
          animate={{
